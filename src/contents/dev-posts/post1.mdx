...
location: "Vancouver"
images:
  - ./images/post1/inet-cidr-anatomy.svg
  - ./images/post1/ip-family.svg
  - ./images/post1/network-bits.svg
  - ./images/post1/key-design.svg
tags: ["postgres"]
PR: https://github.com/tongyin002/gatswind/blob/master/src/contents/dev-posts/post1.mdx
---
...
<props.imgs.Img1 caption="The anatomy of inet and cidr values." />
...
<props.imgs.Img2 caption="One bit reserved for IP family." />
...
<props.imgs.Img3 caption="Number of bits available to store network per datum size and IP family." />
...
<props.imgs.Img4 caption="The design of abbreviated keys for inet and cidr." />
